...
void AddSC_boss_felmyst()
{
    ...
    pNewsScript = new Script;
    pNewsScript->Name = "boss_felmyst";
    pNewsScript->GetAI = &GetAI_boss_felmyst;
    pNewsScript->RegisterSelf();

    pNewsScript = new Script;
    pNewsScript->Name="mob_felmyst_vapor";
    pNewsScript->GetAI = &GetAI_mob_felmyst_vapor;
    pNewsScript->RegisterSelf();

    pNewsScript = new Script;
    pNewsScript->Name = "mob_fog_of_corruption";
    pNewsScript->GetAI = &GetAI_mob_fog_of_corruption;
    pNewsScript->RegisterSelf();
}