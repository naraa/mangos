...
# Dumping data for table mangos.player_factionchange_spells: 844 rows
/*!40000 ALTER TABLE `player_factionchange_spells` DISABLE KEYS */;
INSERT IGNORE INTO `player_factionchange_spells` (`race_A`, `alliance_id`, `commentA`, `race_H`, `horde_id`, `commentH`) VALUES
