...
namespace EventAI
{
    static class DBC
    {
        ...
        public static Dictionary<uint, AchievementEntry> Achievement;
        ...
        public static Dictionary<uint, string> _MapEntryStrings         = new Dictionary<uint, string>();
        public static Dictionary<uint, string> _AchievementStrings      = new Dictionary<uint, string>();
        // 
